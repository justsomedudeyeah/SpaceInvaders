...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color = RED, size = 10):
        """
...
class Ship(pygame.sprite.Sprite):
    ...
    def __init__(self, path, pos_x, pos_y, speed = 7):
        """
        Cria uma nave.
...
class SpaceInvaders():
    ...
    def __init__(self):
        ...
        self.path_image_ship = DIRECTORY + "/images/garf.png"
